        ...
        <div className="w-full lg:w-1/2 p-8 lg:p-10 flex flex-col justify-center">
          ...
          <div className="flex flex-col items-center justify-center mb-8">
            <div className="flex items-center gap-3 mb-1">
              <img src="/icons8-medical-bag-100.png" alt="ClinicPro Icon" className="w-10 h-10 object-contain" />
              <h1 className="text-xl font-bold text-gray-800 dark:text-white tracking-tight">ClinicPro</h1>
            </div>
